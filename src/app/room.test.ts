...
function stateOf(extra: Partial<RoomState> & { hostId?: string; selfId?: string } = {}): RoomState {
  ...
  return {
    ...
    canReady: true, canStart: false, startBlockedBy: 'nobody-ready', secondsLeft: null, round: null,
    isEntrant: false, hasOpened: false, openedCount: 0, entrantCount: 0, canOpen: false, myPrize: null,
