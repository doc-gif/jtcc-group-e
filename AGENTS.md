...
7. 複数のエージェントが同時に作業するときは [docs/OPERATIONS.md](docs/OPERATIONS.md) に従う。担当の Issue に着手コメントと `in-progress`、PR 本文の先頭に `Closes #N`、共有資源は `lock:*` の Issue で取る。タスクの状況は文書に書き写さず Issue とラベルに置く。
