...
ホストの予約開始とピッチ用デモの5状態を、作業領域 [task/F08 `284:2717`](https://www.figma.com/design/yeDF1BwhrxpXI57Daainle?node-id=284-2717)（Town v2）に作成した。ホストの予約設定 `284:2719`、予約済み（ホスト）`284:2814`、予約済み（参加者）`284:2904`、予約開始できず `284:2985`、結果（ピッチ用デモ）`284:3073`。担当者の確認後にマスターへ移し、上の表に node を追加する。
